...
export const CardInvitacion = ({
  ...
  const handleAceptar = async () => {
    try {
      ...
      onAceptar();
      show("success", "Solicitud aceptada con éxito");
    } catch {
  ...
  const handleRechazar = async () => {
    try {
      ...
      show("success", "Solicitud rechazada con éxito");
      onRechazar();
    } catch {
      show("error", "Error inesperado intenta mas tarde");
    }
    ...
    >
      <View style={styles.encabezado}>
        ...
        <View style={styles.info}>
          ...
          <Parrafo variante="blancoM">Discord: {discord}</Parrafo>
        </View>
